          ...
          <div className="row">
            <div className="col-3">
              ...
              <address className="text-white fs-6">
                Hno : 250 Near BVB Campus <br /> Vidyanagar, Hubli <br />
                PinCode: 580031 
              </address>
              <a href="tel: +91 9886389764" className="mt-3 d-block mb-1 text-white">
                +91 9886389764
              </a>

              <a href="mailto: sachin.cs2002p@gmail.com" className="mt-2 d-block mb-0 text-white">
          ...
          <div className="row">
            <div className="col-12">
              <div className="text-center mb-0 text-white">
                <p>
                  &copy; { new Date().getFullYear() }; Powered By Sacker
                </p>
              </div>
            </div>
          </div>
